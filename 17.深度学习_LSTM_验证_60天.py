...
def main():
	...
	models = load_model("./深度学习模型/model_"+stock_code+"_60_1层.h5")

	# score = models.evaluate(x_train, y_train, verbose=1, batch_size=32)
	# print('loss:', score)
	...
	x_test = [testing_set_scaled_x[0:60, :]]
