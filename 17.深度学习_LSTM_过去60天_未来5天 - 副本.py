...
def save_model(model, stock_code):
	# model.save("./深度学习模型/model_"+stock_code+"_60.h5")
	model.save("./深度学习模型/model_"+stock_code+"_60_1层.h5")
...
def main():
	...
	#1层 60天
	models = fit_data(x_train, y_train, 1000, 32)

	save_model(models, stock_code)

	score = models.evaluate(x_train, y_train, verbose=2, batch_size=128)
	print('loss:', score)
