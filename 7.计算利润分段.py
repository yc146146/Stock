...
if __name__ == '__main__':
	...
	profit_file = open("./计算利润/"+stock_code+".csv", "w",encoding="gbk")
	...
	# res_money = init_money
	# #合并计算
	# for date_data in stock_date_trade_group_list:
	# 	in_price = stock_in_pd[stock_in_pd["date"]==date_data["in"]]["stock_second_close"].values[0]
	# 	out_price = stock_out_pd[stock_out_pd["date"]==date_data["out"]]["stock_second_close"].values[0]

	# 	stock_num = math.floor(res_money/in_price)

	# 	res_money = stock_num * out_price

	# 	# print(in_price)
	# 	# print(out_price)
	# 	print("共计",res_money)
	# 	print("盈利",res_money - init_money)
