...
stock_pd = pd.read_csv("./数据文件/数据合并处理/sh.600000_day_qfq_c.csv", encoding="gbk")

# print(stock_pd.head())

industry_pd = pd.read_csv("./数据文件/行业数据分析/历史交易时间线研究/银行.csv", encoding="gbk")
...
plt.plot(merge_date_pd["date"],merge_date_pd["industry_pbMRQ_mean"],color="green",linestyle="-",marker="|", label="industry_pbMRQ_mean")  
plt.plot(merge_date_pd["date"],merge_date_pd["industry_psTTM_mean"],color="blue",linestyle="-",marker="|", label="industry_psTTM_mean")  
plt.plot(merge_date_pd["date"],merge_date_pd["industry_pcfNcfTTM_mean"],color="skyblue",linestyle="-",marker="|", label="industry_pcfNcfTTM_mean")  
plt.plot(merge_date_pd["date"],merge_date_pd["industry_peTTM_mean"],color="purple",linestyle="-",marker="|", label="industry_peTTM_mean")  



# plt.plot(merge_date_pd["date"],merge_date_pd["stock_main_close"],color="blue",linestyle="-",marker="|", label="stock_main_close")  
plt.plot(merge_date_pd["date"],merge_date_pd["stock_second_close"],color="black",linestyle="-",marker="|", label="stock_second_close")  
plt.plot(merge_date_pd["date"],merge_date_pd["pbMRQ"],color="red",linestyle="-",marker="|", label="pbMRQ")  
plt.plot(merge_date_pd["date"],merge_date_pd["psTTM"],color="gold",linestyle="-",marker="|", label="pbMRQ")  
plt.plot(merge_date_pd["date"],merge_date_pd["pcfNcfTTM"],color="palegreen",linestyle="-",marker="|", label="pcfNcfTTM")  
plt.plot(merge_date_pd["date"],merge_date_pd["peTTM"],color="peru",linestyle="-",marker="|", label="peTTM")  
